...
import com.app.hotel.common.models.Pagination;
...
public class OffsetPaginatedResponse<T> extends ResponseFactory<T> {
    // Getters y setters para `pagination`
    private Pagination pagination;

    public OffsetPaginatedResponse(boolean success, String message, T result, long total, int perPage, int currentPage, String baseUrl) {
        super(success, message, result);
        this.setPagination(new Pagination(total, perPage, currentPage));
